...
CREATE TABLE `proyectos` (
  ...
  KEY `IX_Proyectos_LineaId` (`LineaId`),
  KEY `IX_Proyectos_OficinaId` (`OficinaId`),
  KEY `IX_Proyectos_UnidadId` (`UnidadId`),
  CONSTRAINT `FK_Proyectos_Linea_LineaId` FOREIGN KEY (`LineaId`) REFERENCES `linea` (`LineaId`) ON DELETE CASCADE,
  CONSTRAINT `FK_Proyectos_Oficina_OficinaId` FOREIGN KEY (`OficinaId`) REFERENCES `oficina` (`OficinaId`) ON DELETE CASCADE,
  CONSTRAINT `FK_Proyectos_Unidad_UnidadId` FOREIGN KEY (`UnidadId`) REFERENCES `unidad` (`UnidadId`) ON DELETE CASCADE,
...
INSERT INTO `proyectos` VALUES (1,'2018-07-10 00:00:00','BCA','Admin',_binary '\0',0,0,0,0),(2,'2018-07-10 00:00:00','TESCO','Admin',_binary '\0',0,0,0,0),(3,'2018-07-10 00:00:00','BestDay','User',_binary '\0',0,0,0,0),(4,'2018-07-10 00:00:00','RANDSTAD','User',_binary '\0',0,0,0,0),(5,'2018-12-18 09:16:38','Equipo de pruebas de jherrric','jherrric',_binary '',0,0,0,0),(6,'2019-01-08 14:25:35','Equipo de pruebas de mcampong','mcampong',_binary '',0,0,0,0),(7,'2019-01-28 14:21:49','Equipo de pruebas de cgonzaro','cgonzaro',_binary '',0,0,0,0),(9,'2019-01-28 15:16:36','Equipo de pruebas de marcossa','marcossa',_binary '',0,0,0,0),(10,'2019-05-03 11:18:40','DES BigData UK','marcossa',_binary '\0',2,2,7,2),(11,'2019-05-03 11:18:40','DES BigData Zurich','marcossa',_binary '\0',2,2,15,2),(12,'2019-05-03 11:18:40','DES CHAFEA','marcossa',_binary '\0',3,2,11,2),(13,'2019-05-03 11:18:40','AM CTS','marcossa',_binary '\0',4,3,6,3),(14,'2019-05-03 11:18:40','GESTOROT','marcossa',_binary '\0',5,4,6,4),(15,'2019-05-03 11:18:40','PGECADIS','marcossa',_binary '\0',6,4,0,4),(16,'2019-05-03 11:18:40','DES BMW SA3','marcossa',_binary '\0',7,5,0,5),(17,'2019-05-03 11:18:40','DES BID','marcossa',_binary '\0',8,6,0,6),(18,'2019-05-03 13:21:55','Equipo de pruebas de agiampas','agiampas',_binary '',1,1,1,1);
...
INSERT INTO `userproyectos` VALUES (1,'Admin',1),(2,'Admin',2),(3,'Admin',3),(4,'User',1),(5,'jherrric',5),(6,'mcampong',6),(7,'cgonzaro',7),(9,'marcossa',9),(10,'agiampas',18);
...
-- Dump completed on 2019-05-10 12:05:28
